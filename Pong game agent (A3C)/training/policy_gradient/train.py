...
while episode_n < 10000:
    ...
    while episode_done < 20:
        ...
        observation_delta_player_1 = last_observation_player1 - observation_player_1
        observation_delta_player_2 = last_observation_player2 - observation_player_2
        ...
        up_probability_player_2 = opponent.get_action(observation_delta_player_2)
    ...
    if episode_n % 500 == 0:
        player.save_checkpoint('checkpoints-3/checkpoints-player-%i.pth'%(episode_n));
